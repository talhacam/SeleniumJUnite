...
public class C03_Assertions {
    ...
    public void test1() {
        ...
        //Assert.assertTrue(actualUrl.contains(expectedUrl)); diğer bir yöntem
    ...
    public void test3() {
        ...
        //Assert.assertTrue(driver.findElement(By.xpath("(//*[@class='logo'])[1]")).isDisplayed()); Böyle tek satırda da yapılabilir.
