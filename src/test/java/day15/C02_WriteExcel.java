...
public class C02_WriteExcel {
    ...
    public void test1() throws IOException {
        ...
        //Olusturdugumuz hucreye “Nufus” immorality
        ...
        workbook.getSheet("Sayfa1").getRow(14).createCell(4).setCellValue("54.000"); //Tırnak içerisinde de yazabiliriz. Ayrıca tırnak içerisine noktalı bir şekilde yazabiliriz.
